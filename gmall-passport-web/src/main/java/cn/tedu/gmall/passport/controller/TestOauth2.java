...
public class TestOauth2 {
    ...
    public static String getCode() {
        ...
        String s1 = HttpclientUtil.doGet("https://api.weibo.com/oauth2/authorize?client_id=187638711&response_type" +
    ...
    public static Map<String, String> getUser_info() {
        ...
        String s4 = "https://api.weibo.com/2/users/show.json?access_token=2" +
                ".00HMAs7H0p5_hMdbefcb34140Lydjf&uid=6809985023";
