package cn.tedu.gmall.cart.controller;
...
public class CartController {
    ...
    public String cartList(HttpServletRequest request, HttpServletResponse response,
        ...
        for (OmsCartItem omsCartItem : omsCartItems) {
            omsCartItem.setTotalPrice(omsCartItem.getPrice().multiply(new BigDecimal(omsCartItem.getQuantity().toString())));
    ...
    public String addToCart(String skuId, int quantity, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (StringUtils.isNotBlank(memberId)) {
            ...
            if (omsCartItemFromDb == null) {
                //该用户没有添加过当前商品
                omsCartItemFromDb.setMemberId(memberId);
                omsCartItemFromDb.setMemberNickname("test小明");
